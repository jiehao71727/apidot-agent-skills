...
- Adds APIDot usage guidance for image generation, video generation, chat, music, 3D generation, polling, and webhooks.
- Documents API key safety rules and official APIDot links.
