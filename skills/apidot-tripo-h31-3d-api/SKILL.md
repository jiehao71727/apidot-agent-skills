---
name: apidot-tripo-h31-3d-api
description: "Use APIDot for Tripo H3.1 3D API workflows, including Tripo H3.1 API, text-to-3D API, image-to-3D API, multiview-to-3D API, 3D asset generation, async task submission, task_id handling, polling, task status, and webhook integration based on APIDot docs."
homepage: https://apidot.ai/models/tripo-h31-3d
metadata:
  openclaw:
...
This skill is for routing Tripo H3.1 3D questions to the right APIDot docs, examples, reference notes, and async integration pattern. It is documentation-only: it includes no scripts, makes no network requests, and does not store credentials.
...
| --- | --- |
| Browse APIDot Tripo H3.1 model page | https://apidot.ai/models/tripo-h31-3d |
...
Use `references/api.md` for a local, non-executable summary of Tripo H3.1 model routing, request planning, and async workflow notes.
...
- Tripo H3.1 model page: https://apidot.ai/models/tripo-h31-3d
