# APIDot Seedance 1.0 Pro Reference

This reference gives agents a safer, non-executable summary for APIDot Seedance 1.0 Pro integration work. Use it to choose the right documentation path and request mode before opening the live APIDot docs or general APIDot examples.

It contains no shell commands, no runnable request examples, no bundled clients, and no stored credentials.

## Source Of Truth

- Model page: https://apidot.ai/models/seedance-1-0-pro
- API docs: https://apidot.ai/docs/seedance-1-0-pro
...
Seedance 1.0 Pro on APIDot is for prompt-driven and optional image-guided short video workflows that need controlled duration, resolution planning, storyboard drafts, product teasers, or social ad clips when supported by the selected request mode.

The documented APIDot model entry is:

| Model Entry | Best Fit |
| --- | --- |
| `seedance-1.0-pro` | Seedance 1.0 Pro text-to-video and image-to-video jobs through APIDot. |

Do not assume Seedance 1.5 Pro or Seedance 2 fields apply to Seedance 1.0 Pro. Check the APIDot Seedance 1.0 Pro docs before preparing a payload.
...
APIDot Seedance 1.0 Pro jobs follow the shared APIDot async generation flow:
...
- Do not copy fields from another video model family unless the APIDot docs show the same field for Seedance 1.0 Pro.
