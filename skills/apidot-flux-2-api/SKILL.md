...
This skill is for routing FLUX.2 questions to the right APIDot docs, model pages, and async integration guidance. It is documentation-only: it includes no scripts, makes no network requests, and does not store credentials.
